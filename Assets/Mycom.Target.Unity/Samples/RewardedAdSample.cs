    ...
    public sealed class RewardedAdSample : MonoBehaviour
    {
        ...
        private void Show(UInt32 slotId)
        {
            ...
            lock (_syncRoot)
            {
                ...
                _rewardedAd.AdClicked += (s, e) => StandardAdSample.Log("RewardedAdSample: OnAdClicked");
                _rewardedAd.AdDismissed += (s, e) =>
                {
                    StandardAdSample.Log("RewardedAdSample: OnAdDismissed");
                    OnDestroy();
                };
                _rewardedAd.AdDisplayed += (s, e) => StandardAdSample.Log("RewardedAdSample: OnAdDisplayed");
                _rewardedAd.AdLoadFailed += (s, e) =>
                {
                    StandardAdSample.Log("RewardedAdSample: OnAdLoadFailed, error " + e.Message);
                    OnDestroy();
                };
                _rewardedAd.AdRewarded += (s, e) => StandardAdSample.Log("RewardedAdSample: OnAdRewarded");
