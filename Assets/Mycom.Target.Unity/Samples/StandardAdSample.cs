    ...
    public sealed class StandardAdSample : MonoBehaviour
    {
        ...
        private void OnButtonClicked(UInt32 slotId, MyTargetView.AdSize adSize)
        {
            lock (_syncRoot)
            {
                ...
                _myTargetView.AdClicked += (s, e) => StandardAdSample.Log("StandardAdSample: OnAdClicked");
                _myTargetView.AdLoadFailed += (s, e) => StandardAdSample.Log("StandardAdSample: OnAdLoadFailed");
        ...
        {
            StandardAdSample.Log("OnAdLoadCompleted");
