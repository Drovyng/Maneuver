...
namespace Mycom.Target.Unity.Samples
{
    ...
    public sealed class InterstitialAdSample : MonoBehaviour
    {
        ...
        {
            StandardAdSample.Log("IntersititialAdSample:  OnAdLoadCompleted");
        ...
        private void Show(UInt32 slotId)
        {
            ...
            lock (_syncRoot)
            {
                ...
                _interstitialAd.AdClicked += (s, e) => StandardAdSample.Log("InterstitialAdSample: OnAdClicked");
                _interstitialAd.AdDismissed += (s, e) =>
                {
                    StandardAdSample.Log("InterstitialAdSample: OnAdDismissed");
                    OnDestroy();
                };
                _interstitialAd.AdDisplayed += (s, e) => StandardAdSample.Log("InterstitialAdSample: OnAdDisplayed");
                _interstitialAd.AdLoadFailed += (s, e) =>
                {
                    StandardAdSample.Log("InterstitialAdSample: OnAdLoadFailed, error " + e.Message);
                    OnDestroy();
                };
                _interstitialAd.AdVideoCompleted += (s, e) => StandardAdSample.Log("InterstitialAdSample: OnAdVideoCompleted");
