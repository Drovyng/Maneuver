...
namespace YandexMobileAds.Platforms.iOS
{
    ...
    public class InterstitialClient : IInterstitialClient, IDisposable
    {
        ...
        public InterstitialClient(string blockId)
        {
            ...
            ObjectId = InterstitialBridge.YMAUnityCreateInterstitial(
                selfPointer, blockId);
        ...
        {
            return InterstitialBridge.YMAUnityIsInterstitialLoaded(ObjectId);
        }

        public void Show()
        {
            InterstitialBridge.YMAUnityShowInterstitial(ObjectId);
        }
