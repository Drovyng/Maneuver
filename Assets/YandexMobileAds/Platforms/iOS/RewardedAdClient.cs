...
namespace YandexMobileAds.Platforms.iOS
{
    ...
    public class RewardedAdClient : IRewardedAdClient, IDisposable
    {
        ...
        public RewardedAdClient(string blockId)
        {
            ...
            ObjectId = RewardedAdBridge.YMAUnityCreateRewardedAd(
                selfPointer, blockId);
        ...
        {
            return RewardedAdBridge.YMAUnityIsRewardedAdLoaded(ObjectId);
        }

        public void Show()
        {
            RewardedAdBridge.YMAUnityShowRewardedAd(ObjectId);
        }
